...
( pocketsphinx_continuous -inmic yes -kws keyphrase.list -backtrace yes -adcdev default -rawlogdir ./logdir -logfn ./logdir/pocketsphinx.log -time yes -samprate 16000 3>&1 1>&2- 2>&3- ) | python ./processkws.py